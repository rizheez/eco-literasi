    ...
    <div className="space-y-6 py-4">
      ...
      <div className="flex items-center space-x-3">
        {activeScenarioIdx === null ? (
          ...
          <button onClick={() => { playSound('click'); setActiveScenarioIdx(null); }} className="p-3 bg-white rounded-2xl border-2 border-emerald-100 hover:bg-emerald-50 transition text-slate-700 cursor-pointer">
            <ChevronLeft size={24} />
          </button>
        )}
        <div>
